...
const consolidatedData: YearBlock[] = [
...

  {
    ...
    items: [
      ...
      { label: 'Q3- Unaudited Financial Statement', href: '/uploads/2025-26/Consolidate/Console.pdf' },
      { label: 'Q4- Audited Financial Statement', href: '/uploads/2025-26/Consolidate/ConsoleMarch.pdf' },
    ],
  },
  {
    year: 'Financial Results 2024-25',
    items: [
      { label: 'Q1- Unaudited Financial Statement', href: '/uploads/2024-25/Consolidate/June24Console.pdf' },
      ...
      { label: 'Q4- Audited Financial Statement', href: '/uploads/2024-25/Consolidate/ARConsole_March25.pdf' },
    ],
  },
  {
    year: 'Financial Results 2023-24',
    items: [
      { label: 'Q1- Unaudited Financial Statement', href: '/uploads/2023-24/consolidate/June23Console.pdf' },
      ...
      { label: 'Q4- Audited Financial Statement', href: '/uploads/2023-24/consolidate/March24Console.pdf' },
    ],
  },
];
