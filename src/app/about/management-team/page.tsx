            ...
            <div className="column">
              ...
              <div className="team-member team-member--open">
                ...
                <div className="toggle-content clearfix">
                  <div className="team-member-photo-wrap">
                    <Image
                      src="/assets/team/AnubhavDham.png"
                      alt="Mr. Anubhav Dham"
                      width={220}
                      height={220}
              ...
              <div className="team-member team-member--open">
                ...
                <div className="toggle-content clearfix">
                  ...
                  <div className="bio-content">
                    <p>
                      Mr. Manish Makhija is a seasoned finance professional with over 32 years of experience in finance, accounts, strategic planning, treasury management, and financial controls.
                    </p>
                    <p>
...
//               <div className="team-grid">
//                 {/* ROW 1: Anubhav Dham and Anamika Dham - side by side */}
                
//                 {/* Mr. Anubhav Dham - Managing Director and Chairperson */}
//                 <div className="team-member team-member--open team-member--half">
//                   <h5 className="toggle-title toggle-title--centered">
//                     Mr. Anubhav Dham – Managing Director and Chairperson
//                   </h5>
//                   <div className="toggle-content clearfix">
...
//                 {/* ROW 2: Aarti Jain - full width */}
//                 <div className="team-member team-member--open team-member--full">
//                   <h5 className="toggle-title toggle-title--centered">
//                     Ms. Aarti Jain – Managing Director
//                   </h5>
//                   <div className="toggle-content clearfix">
...
//                 {/* ROW 3: Rajat Agrawal - full width */}
//                 <div className="team-member team-member--open team-member--full">
//                   <h5 className="toggle-title toggle-title--centered">
//                     Mr. Rajat Agrawal – Chief Executive Officer
//                   </h5>
...
//                 {/* ROW 4: Manish Makhija - full width */}
//                 <div className="team-member team-member--open team-member--full">
//                   <h5 className="toggle-title toggle-title--centered">
//                     Mr. Manish Makhija – Group CFO
//                   </h5>
...
//                 {/* ROW 5: Sanjeev Khanna - full width */}
//                 <div className="team-member team-member--open team-member--full">
//                   <h5 className="toggle-title toggle-title--centered">
//                     Mr. Sanjeev Khanna – Senior Vice President 
//                   </h5>
...
//                 {/* ROW 6: Narender Sharma - full width */}
//                 <div className="team-member team-member--open team-member--full">
//                   <h5 className="toggle-title toggle-title--centered">
//                     Mr. Narender Kumar Sharma – Company Secretary
//                   </h5>
...
//                 {/* ROW 7: Sudhanshu Singhal - full width */}
//                 <div className="team-member team-member--open team-member--full">
//                   <h5 className="toggle-title toggle-title--centered">
//                     Mr. Sudhanshu Singhal – Independent Director
//                   </h5>
...
//                 {/* ROW 8: Ritesh Kalra and Neeraj Jain - side by side */}
